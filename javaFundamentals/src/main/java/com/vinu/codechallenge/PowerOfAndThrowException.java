...
This method takes two integers, n and p, as parameters and finds n to the power p. 
If either n or p is negative, then the method must throw an exception which says "n or p should not be negative.". 
Also, if both n and n are zero, then the method must throw an exception which says "n and p should not be zero."
...
public class PowerOfAndThrowException {
